...
from Websocket.models import SessionMetadata, NowPlayingResponse, QueueResponse, BlocklistResponse, Error, SkipSongResponse, UnblockSongResponse, BlockSongResponse, RemoveSongResponse, PlaySongResponse, ReloadAllResponse
...
class PewHits:
    ...
    async def on_start_now_playing(
        ...
        from config.songHandler import get_now_playing_data
    ...
    async def next_coming(
        ...
        """
        from config.songHandler import get_next_coming_data
    ...
    async def queue(
        ...
        from config.requestHandler import get_requests
    ...
    async def blocklist(
        ...
        from config.blocker import list_blocked_songs
...
class PewHitsServer:
    ...
    async def remove_blocked_song(
        ...
        from config.request_adder import get_app_id
        from config.blocker import remove_song_by_index
    ...
    async def block_current_song(
        ...
        from config.songHandler import get_now_playing_data
        from config.request_adder import get_app_id
        from config.blocker import add_song
    ...
    async def remove_song(
        ...
        from config.request_adder import get_app_id
        from config.requestHandler import remove_request_by_index
    ...
    async def play_song(
        ...
        from config.request_adder import request_maker
